						...
						<div class="form-tab form-tab-add">
							<div class="form-tab-header">
								<p class="form-tab-header-name">
									...
									<span class="editable-name" data-base-name="Local">Local</span>
								</p>
							...
							<form class="form">
								...
								<label>
									<div class="input-radio-wrap">
										<input type="radio" name="local" />
										<p>Local de actividad</p>
									</div>
								</label>
	
								<label class="label-checkbox-switch">
									<p>¿Sistemas de seguridad? <span class="popup-icon">?</span></p>
	
									<span class="popup">
										Si eres una gestoría, puede que trates datos de clientes/empleados de TUS cliente
									</span>
	
									<input type="checkbox" class="checkbox-switch close-inputs" data-block="3" />
								</label>
								...
								<label>
									<p>Observaciones <span class="popup-icon">?</span></p>
